...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
	...
	*/
	...
	if (this->HarderChkBox->Checked)
	{
		ms->Position = 0x1A77;
		ms->WriteBuffer("\x8B\xFF\x8B\xFF\x90",5);
	}else
	{
		BYTE Buf2[80] = {0xC3};
		ms->Position = 0x1A7C;
		ms->WriteBuffer(&Buf2,62);
		ms->Position = 0x19BA;
		ms->WriteBuffer("\x8B\xFF\x8B\xFF\x8B\xFF\x8B\xFF\x8B\xFF\x8B\xFF\x8B\xFF",14);
	}
